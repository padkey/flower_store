                ...
                <tr>
                    ...
                    <td>
                        <div class="thaotac-admin">
                            ...
                            <div class="delete">
                                <a href="../mvc/Views/admin/category/index.php?controller=CategoryAdmin&action=deletesubject&id=<?php echo $subject['category_id'];?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </div>
