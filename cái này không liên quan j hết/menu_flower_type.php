    ...
    <div class="box-show-all">
        <table class="show">
            ...
            <?php foreach ($flowerTypes as $flowerType): ?>
                ...
                <tr>
                    <td><?php echo $flowerType['category_id']; ?></td>
                    <td><?php echo $flowerType['category_name']; ?></td>
                    <td><?php echo $flowerType['parent_id']; ?></td>
                    <td><?php echo $flowerType['icon']; ?></td>
                    <td>
                        <div class="thaotac-admin">
                            ...
                            <div class="delete">
                                <a href="../mvc/Views/admin/category/index.php?controller=CategoryAdmin&action=deleteFlowerType&id=<?php echo $flowerType['category_id'];?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </div>
