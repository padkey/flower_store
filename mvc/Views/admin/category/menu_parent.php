    ...
    <div class="box-show-all">
        ...
        <table class="show">
            ...
            <?php foreach ($parents as $parent): ?>
                ...
                <tr>
                    <td><?php echo $parent['category_id']; ?></td>
                    ...
                    <td>
                        <div class="thaotac-admin">
                            ...
                            <div class="delete">
                                <a href="index.php?controller=CategoryAdmin&action=deleteCategoryParent&id=<?php echo $parent['category_id'];?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </div>
